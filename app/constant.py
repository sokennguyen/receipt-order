...
DISH_META_BY_ID: dict[str, dict[str, str | list[str] | None]] = {
    ...
    "sausage_gimbap": {"display_name": "Sausage Gimbap", "aliases": [], "print_label": None},
    ...
    "chicken_ramyun": {"display_name": "Chicken Ramyun", "aliases": ["chix", "chicken", "ci"], "print_label": None},
    "original_ramyun": {"display_name": "Original Ramyun", "aliases": [], "print_label": None},
    ...
    "ssamjang_side": {"display_name": "Ssamjang", "aliases": [], "print_label": None},
